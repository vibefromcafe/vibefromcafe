...
## Context
The current repository contains the desired Vibe From Cafe visual direction and homepage narrative. The upstream `zainfathoni/vibefromcafe` repository contains the desired deployment and runtime architecture.
...
- Future UI work should not blindly copy upstream screens when they conflict with the VFC design direction.
