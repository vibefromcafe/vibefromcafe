...
export default function ContactPage() {
  ...
  return (
    <PageFrame eyebrow="/ CONTACT" title="Tell us the AI project you want to make real." intro="A lightweight intake for businesses that want VFC to design and build useful AI assistants, automation, or custom products.">
