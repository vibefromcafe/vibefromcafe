...
export default function AboutPage() {
  return (
    <PageFrame eyebrow="/ ABOUT VFC" title="Built around a table, not a stage." intro="Vibe From Cafe is an AI community for learning, sharing, and career growth through discussions, sessions, hands-on building, webinars, and podcasts, with an adjacent studio that helps businesses build useful AI.">
